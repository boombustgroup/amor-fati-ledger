...
- **`DistributeModel.scala`** (shared pure distribution model) — canonical executable semantics for production floor-with-residual distribution, and the primary bridge target for the Stainless proof shape
